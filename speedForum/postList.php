...
<div class='parallax parallaxForum' style="height:480px">
</div>
<?php
	$post = new post();
	$listPosts = $post->getPostInfo(true, $_GET['categories']);
	echo "<div class='myContainer'>";
	echo "<table class='table table-striped table-dark'>";
		echo "<thead>";
			echo "<tr>";
				echo "<th style='width:5%' scope='col'>#</th>";
				echo "<th style='width:55%' scope='col'>Title</th>";
				echo "<th style='width:10%' scope='col'>Writer</th>";
				echo "<th style='width:10%' scope='col'>Likes</th>";
				echo "<th style='width:10%' scope='col'>Replies/Visited</th>";
				echo "<th style='width:10%' scope='col'>Last Replied</th>";
			echo "</tr>";
		echo "</thead>";
		echo "<tbody>";
			for($i=0; $i<sizeof($listPosts); $i++){
				echo"<tr>";
					...
					echo "<td class='postHref' onclick=\"location.href=''\">".$listPosts[$i]['post_title']."</td>";
					echo "<td class='postHref'>".$listPosts[$i]['username']."</td>";
					echo "<td class='postHref'>0</td>";
					echo "<td class='postHref'>".$listPosts[$i]['post_numberOfvisits']."</td>";
					echo "<td class='postHref'>asdf</td>";
				echo "<tr>";
			}
		echo "</tbody>";
	echo "</table>";
	echo "</div>";
?>
<div class='parallax parallaxForum' style="height:120px">
</div>
